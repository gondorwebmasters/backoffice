  ...
  return (
    <section className="rounded-2xl border border-zinc-200/80 bg-white shadow-card transition-shadow hover:shadow-card-hover">
      <header className="border-b border-zinc-100 px-7 py-5">
        <h2 className="text-sm font-semibold text-zinc-900">Apariencia</h2>
        <p className="text-xs text-zinc-400">Tema y color de acento — se guarda en este dispositivo</p>
      </header>

      <div className="space-y-6 p-7">
        <div className="space-y-1.5">
          <span className="text-xs font-medium uppercase tracking-wider text-zinc-400">Modo</span>
          <div className="grid grid-cols-3 gap-1 rounded-xl bg-zinc-100 p-1" role="radiogroup" aria-label="Modo de tema">
        ...
        <div className="space-y-1.5">
          <span className="text-xs font-medium uppercase tracking-wider text-zinc-400">Color de acento</span>
